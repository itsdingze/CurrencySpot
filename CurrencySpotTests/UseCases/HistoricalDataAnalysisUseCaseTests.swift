...
struct HistoricalDataAnalysisUseCaseTests {
    ...
    func mergeHistoricalData_bothDataSets_shouldMergeWithoutDuplicates() throws {
        ...
        let newData = [
            HistoricalRateSnapshot(date: date2, rates: [HistoricalRatePoint(currencyCode: "GBP", rate: 0.87)]), // Duplicate date
            HistoricalRateSnapshot(date: date3, rates: [HistoricalRatePoint(currencyCode: "JPY", rate: 110.0)]), // New date
        ]
