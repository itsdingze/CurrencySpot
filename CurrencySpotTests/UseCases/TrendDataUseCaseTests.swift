...
struct TrendDataUseCaseTests {
    ...
    private static let sampleTrendData: [Trend] = [
        Trend(currencyCode: "EUR", weeklyChange: 2.5, miniChartData: [1.0, 1.01, 1.02, 1.025, 1.025]),
        Trend(currencyCode: "GBP", weeklyChange: -1.8, miniChartData: [0.85, 0.84, 0.835, 0.832, 0.847]),
    ...
    private static func windowHistoricalData() -> [HistoricalRateSnapshot] {
        [
            HistoricalRateSnapshot(date: day(-6), rates: [
                HistoricalRatePoint(currencyCode: "EUR", rate: 1.0),
                HistoricalRatePoint(currencyCode: "GBP", rate: 0.80),
            ]),
            HistoricalRateSnapshot(date: day(-1), rates: [
                HistoricalRatePoint(currencyCode: "EUR", rate: 1.1),
                HistoricalRatePoint(currencyCode: "GBP", rate: 0.76),
            ]),
        ]
    }
    ...
    func calculateTrendsComputesWeeklyChangeAndSparkline() throws {
        ...
        let rows = [
            ...
            HistoricalRateSnapshot(date: Self.day(-3), rates: [HistoricalRatePoint(currencyCode: "EUR", rate: 1.1)]),
        ]
